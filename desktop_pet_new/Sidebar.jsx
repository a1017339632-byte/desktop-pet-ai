    ...
    <div className="panel panel-sidebar sidebar">
      <div className="sidebar-logo" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span>{(window.__petConfig||{}).charName||'AI'}</span>
        </div>
      ...
      <div className="sidebar-status">
        <div className="status-chip"><span className={`status-dot ${online ? "green" : connected ? "orange" : "red"}`}></span>{online ? `${(window.__petConfig||{}).charName||'AI'}在线` : connected ? "等待连接" : "离线"}</div>
