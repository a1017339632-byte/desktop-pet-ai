  ...
  return (
    <div className="page">
      <div className="panel page-main" style={{ width: "50px" }}>
        ...
        <div className="page-subtitle">{`${(window.__petConfig||{}).charName||'AI'}偷偷干了些什么`}</div>
        <div style={{ display: "flex", flexDirection: "column", gap: 10, marginTop: 4 }}>
          ...
          <div key={i} className="surface" style={{ display: "flex", flexDirection: "column", gap: 4 }}>
            ...
            <div className="surface" style={{ padding: "24px 0", textAlign: "center" }}>
              <div style={{ fontSize: 14, color: "var(--text-tertiary)" }}>{`等待${(window.__petConfig||{}).charName||'AI'}上线...`}</div>
            </div>
          )}
        </div>
